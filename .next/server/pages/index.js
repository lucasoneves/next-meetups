...
async function getStaticProps() {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://lucasneves:PMFtmHxjb19MYRLk@sandbox.fflys.mongodb.net/test?retryWrites=true&w=majority");
  const db = client.db();
